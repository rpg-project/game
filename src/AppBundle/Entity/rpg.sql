...
INSERT INTO `FollowersItems` VALUES (158,1,12,0),(160,3,12,0),(161,4,12,0),(162,5,12,0);
...
CREATE TABLE `fights` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(45) DEFAULT NULL,
  `fight_zone_id` int(11) DEFAULT NULL,
...
INSERT INTO `fights` VALUES (8,'Fight Loup',15,2);
...
INSERT INTO `infosByCharacter` VALUES (40,27,16),(41,27,24),(42,27,12),(43,27,13);
...
--
-- Table structure for table `monstersByFight`
--

DROP TABLE IF EXISTS `monstersByFight`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `monstersByFight` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `monster_id` int(11) DEFAULT NULL,
  `number` int(11) DEFAULT NULL,
  `fight_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `monsterId_idx` (`monster_id`),
  KEY `f_id_idx` (`fight_id`),
  CONSTRAINT `f_id` FOREIGN KEY (`fight_id`) REFERENCES `fights` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `monster_Id` FOREIGN KEY (`monster_id`) REFERENCES `monsters` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `monstersByFight`
--

LOCK TABLES `monstersByFight` WRITE;
/*!40000 ALTER TABLE `monstersByFight` DISABLE KEYS */;
INSERT INTO `monstersByFight` VALUES (6,1,1,8);
/*!40000 ALTER TABLE `monstersByFight` ENABLE KEYS */;
UNLOCK TABLES;
